...
#def build_model_columns():
 #   v1 = tf.feature_column.categorical_column_with_hash_bucket('v1', hash_bucket_size=100000)
  #  v2 = tf.feature_column.categorical_column_with_hash_bucket('v2', hash_bucket_size=100000)
   # base_columns = [v1,v2]
    #return base_columns
def define_flags():
    flags = tf.app.flags
...
def build_model_columns():
    ...
    # Continuous columns
    #v_user = tf.feature_column.categorical_column_with_hash_bucket('v1', hash_bucket_size=50000)
    #v_ad = tf.feature_column.categorical_column_with_hash_bucket('v2', hash_bucket_size=50000)
